...
**drug_like_filter.py**
This script filters Deepdock output predictions (topn.sdf) for drug-like properties including maximum molecular weight, predicted affinity (from GNINA), and predicted solubility (from [SolTranNet](https://github.com/gnina/SolTranNet)).

**select_unique.py**
This script select the chemically unique compounds out of a list of SMILES using RDKIT. Meant to be used on drug_like_filter.py output.
